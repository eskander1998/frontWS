...
const GetOption = () => {
  ...
  async function fetchData() {
    // console.log("aaaaaaa");
    // fetch("http://localhost:8083/getGetOption")
    //   .then((data) => data.json())
    //   .then((data) => setFacture(data));
    // console.log(Facture);
    axios
      .get(`http://localhost:8083/getOption`, {
        headers: {
  ...
  return (
    <>
      <div className="table-container">
        <div className="row">
          <div className="col">
            <h5 className="pb-2 mb-0">Options</h5>
          </div>
...
export default adminLayout(GetOption);
