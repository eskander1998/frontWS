...
const GetEtat = () => {
  ...
  async function fetchData() {
    // console.log("aaaaaaa");
    // fetch("http://localhost:8083/getGetEtat")
    //   .then((data) => data.json())
    //   .then((data) => setFacture(data));
    // console.log(Facture);
    axios
      .get(`http://localhost:8083/getEtat`, {
        headers: {
  ...
  return (
    <>
      <div className="table-container">
        <div className="row">
          <div className="col">
            <h5 className="pb-2 mb-0">Etat</h5>
          </div>
...
export default adminLayout(GetEtat);
